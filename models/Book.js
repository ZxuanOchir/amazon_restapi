...
const BookSchema = new mongoose.Schema(
  {
    ...
    content: {
      ...
      maxlength: [
        5000,
        'Номын тайлбарын урт дээд тал нь 5000 тэмдэгт байх ёстой.',
      ],
    },
    bestseller: {
      type: Boolean,
...
//Энэ код нь Mongoose-ийн statics функц ашиглан BookSchema дээр computeCategoryAveragePrice нэртэй статик (static) метод үүсгэж байна. Уг метод нь тодорхой catId буюу категори ID-аар Book цуглуулгын дундаж үнийг тооцоолоод, Category цуглуулгад хадгалдаг.
